...
//                postData.categoryId = $jqGridTable.data('category-id');
        ...
        height: 'auto',
        colNames: [' ', 'ID', 'Customer Group ID', 'Name', 'Email', 'Register Time', 'Last Login Time', 'Is Confirmed'],
        colModel: [
            ...
            {name: 'customer_id', index: 'customer_id', width: 70, editable: false, key: true},
            {name: 'customer_group_id', index: 'customer_group_id', width: 70, hidden: true},
            {name: 'name', index: 'title', width: 150, editable: true, editoptions: {size: "20", maxlength: "250"}, editrules: {required: true}},
            {name: 'email', index: 'inventory', width: 70, editable: true, edittype: "text", editrules: {integer: true, minValue: 0}},
            {name: 'register_time', index: 'price', width: 70, editable: true, edittype: "text", editrules: {integer: true, minValue: 0}},
            {name: 'last_login_time', index: 'shipping_fee', width: 70, editable: true, edittype: "text", editrules: {integer: true, minValue: 0}},
